...
import { ShoppingBag, Camera, Sparkles, RefreshCw, AlertTriangle, Globe, Settings, Plus, Trash2 } from 'lucide-react';
    ...
    <header className="bg-white border-b border-stone-200 sticky top-0 z-30 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {userRole === 'owner' && onOpenAddProduct && (
            <button
          ...
          {userRole === 'owner' && onOpenRemoveProduct && (
            <button
              onClick={onOpenRemoveProduct}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold transition-all shadow-sm active:scale-95 cursor-pointer"
            >
